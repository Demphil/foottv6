...
export async function getTodayMatches() {
  ...
  const targetUrl = 'https://www.kora-live-7sry.com/';
...
export async function getTomorrowMatches() {
  ...
  const targetUrl = 'https://www.kora-live-7sry.com/matches-tomorrow-2/';
  const newMatches = await fetchMatches(targetUrl);
...
function extractImageUrl(imgElement) {
  ...
  return `https://www.kora-live-7sry.com/${src.startsWith('/') ? '' : '/'}${src}`;
}
