...
const leagues = [
    ...
    { id: 243, name: 'دوري أبطال اسيا' },
    { id: 38, name: 'الدوري المغربي' },
    { id: 382, name: 'الدوري المصري' },
     { id: 314, name: 'الدوري السعودي' },
    { id: 223, name: 'الدوري ابطال افريقيا ' },
    { id: 224, name: 'الدوري الاتحاد الافريقي ' },
];
