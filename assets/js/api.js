...
export async function getTodayMatches() {
  ...
  const targetUrl = 'https://www.live-koorahnet.com/';
...
export async function getTomorrowMatches() {
  ...
  const targetUrl = 'https://www.live-koorahnet.com/matches-tomorrow/';
  const newMatches = await fetchMatches(targetUrl);
...
function extractImageUrl(imgElement) {
  ...
  return `https://www.live-koorahnet.com/${src.startsWith('/') ? '' : '/'}${src}`;
}
