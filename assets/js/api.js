...
const leagues = [
    ...
    { id: 10, name: 'دوري أبطال اسيا' },
    { id: 450, name: 'البطولة المغربية الإحترافية إنوي القسم الأول' },
    { id: 415, name: 'الدوري المصري الممتاز' },
     { id: 307, name: 'دوري روشن السعودي' },
    { id: 11, name: 'الدوري ابطال افريقيا ' },
    { id: 12, name: 'كأس الكونفيدرالية الأفريقية' },
];
